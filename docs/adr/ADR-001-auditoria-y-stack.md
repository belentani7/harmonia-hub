# ADR-001 -- Auditoria documental y stack de harmonia-hub
Fecha: 2026-09-25 | Estado: aceptado

## Contexto

El repositorio carecia de cadena documental formal (PRD/SRS/SDD/ADR/plan) y de
reglas explicitas para agentes. Stack detectado: Node.js, React, Tailwind, Express, TypeScript, Docker, Deploy: Dockerfile.
